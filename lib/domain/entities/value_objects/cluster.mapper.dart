...
class ClusterMapper extends ClassMapperBase<Cluster> {
  ...
  static const Field<Cluster, int> _f$clusterNumber = Field(
    'clusterNumber',
    _$clusterNumber,
  );
  static int _$uniqueDomains(Cluster v) => v.uniqueDomains;
  static const Field<Cluster, int> _f$uniqueDomains = Field(
    'uniqueDomains',
    _$uniqueDomains,
  );
  static int _$numberOfTitles(Cluster v) => v.numberOfTitles;
  static const Field<Cluster, int> _f$numberOfTitles = Field(
    'numberOfTitles',
    _$numberOfTitles,
  );
  static String _$category(Cluster v) => v.category;
  static const Field<Cluster, String> _f$category = Field(
    'category',
    _$category,
  );
  ...
  static const Field<Cluster, String> _f$shortSummary = Field(
    'shortSummary',
    _$shortSummary,
  );
  static String _$didYouKnow(Cluster v) => v.didYouKnow;
  static const Field<Cluster, String> _f$didYouKnow = Field(
    'didYouKnow',
    _$didYouKnow,
  );
  static List<String> _$talkingPoints(Cluster v) => v.talkingPoints;
  static const Field<Cluster, List<String>> _f$talkingPoints = Field(
    'talkingPoints',
    _$talkingPoints,
  );
  ...
  static const Field<Cluster, String> _f$quoteAuthor = Field(
    'quoteAuthor',
    _$quoteAuthor,
  );
  static String _$quoteSourceUrl(Cluster v) => v.quoteSourceUrl;
  static const Field<Cluster, String> _f$quoteSourceUrl = Field(
    'quoteSourceUrl',
    _$quoteSourceUrl,
  );
  static String _$quoteSourceDomain(Cluster v) => v.quoteSourceDomain;
  static const Field<Cluster, String> _f$quoteSourceDomain = Field(
    'quoteSourceDomain',
    _$quoteSourceDomain,
  );
  static String _$location(Cluster v) => v.location;
  static const Field<Cluster, String> _f$location = Field(
    'location',
    _$location,
  );
  static List<Perspective> _$perspectives(Cluster v) => v.perspectives;
  static const Field<Cluster, List<Perspective>> _f$perspectives = Field(
    'perspectives',
    _$perspectives,
  );
  ...
  static const Field<Cluster, String> _f$designPrinciples = Field(
    'designPrinciples',
    _$designPrinciples,
  );
  static String _$userExperienceImpact(Cluster v) => v.userExperienceImpact;
  static const Field<Cluster, String> _f$userExperienceImpact = Field(
    'userExperienceImpact',
    _$userExperienceImpact,
  );
  static List<String> _$gameplayMechanics(Cluster v) => v.gameplayMechanics;
  static const Field<Cluster, List<String>> _f$gameplayMechanics = Field(
    'gameplayMechanics',
    _$gameplayMechanics,
  );
  static List<String> _$industryImpact(Cluster v) => v.industryImpact;
  static const Field<Cluster, List<String>> _f$industryImpact = Field(
    'industryImpact',
    _$industryImpact,
  );
  static String _$technicalSpecifications(Cluster v) =>
      v.technicalSpecifications;
  static const Field<Cluster, String> _f$technicalSpecifications = Field(
    'technicalSpecifications',
    _$technicalSpecifications,
  );
  static List<Article> _$articles(Cluster v) => v.articles;
  static const Field<Cluster, List<Article>> _f$articles = Field(
    'articles',
    _$articles,
  );
  static List<Domain> _$domains(Cluster v) => v.domains;
  static const Field<Cluster, List<Domain>> _f$domains = Field(
    'domains',
    _$domains,
  );
...
mixin ClusterMappable {
  ...
  bool operator ==(Object other) {
    return ClusterMapper.ensureInitialized().equalsValue(
      this as Cluster,
      other,
    );
  }
