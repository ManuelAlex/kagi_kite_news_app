...
class NewsCategoriesMapper extends ClassMapperBase<NewsCategories> {
  ...
  static const Field<NewsCategories, DateTime> _f$timestamp = Field(
    'timestamp',
    _$timestamp,
  );
  static List<Category> _$categories(NewsCategories v) => v.categories;
  static const Field<NewsCategories, List<Category>> _f$categories = Field(
    'categories',
    _$categories,
  );
...
mixin NewsCategoriesMappable {
  ...
  get copyWith =>
      _NewsCategoriesCopyWithImpl(this as NewsCategories, $identity, $identity);
  @override
  String toString() {
    return NewsCategoriesMapper.ensureInitialized().stringifyValue(
      this as NewsCategories,
    );
  }

  @override
  bool operator ==(Object other) {
    return NewsCategoriesMapper.ensureInitialized().equalsValue(
      this as NewsCategories,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return NewsCategoriesMapper.ensureInitialized().hashValue(
      this as NewsCategories,
    );
  }
}
...
class _NewsCategoriesCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({DateTime? timestamp, List<Category>? categories}) => $apply(
    FieldCopyWithData({
