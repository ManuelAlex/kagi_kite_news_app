...
class NewsCategoriesDto1Mapper extends ClassMapperBase<NewsCategoriesDto1> {
  ...
  static const Field<NewsCategoriesDto1, DateTime> _f$timestamp =
  ...
  static NewsCategoriesDto1 _instantiate(DecodingData data) {
    return NewsCategoriesDto1(
        categories: data.dec(_f$categories), timestamp: data.dec(_f$timestamp));
  }
...
mixin NewsCategoriesDto1Mappable {
  ...
  NewsCategoriesDto1CopyWith<NewsCategoriesDto1, NewsCategoriesDto1,
          NewsCategoriesDto1>
      get copyWith => _NewsCategoriesDto1CopyWithImpl(
          this as NewsCategoriesDto1, $identity, $identity);
  @override
  String toString() {
    return NewsCategoriesDto1Mapper.ensureInitialized()
        .stringifyValue(this as NewsCategoriesDto1);
  }

  @override
  bool operator ==(Object other) {
    return NewsCategoriesDto1Mapper.ensureInitialized()
        .equalsValue(this as NewsCategoriesDto1, other);
  }

  @override
  int get hashCode {
    return NewsCategoriesDto1Mapper.ensureInitialized()
        .hashValue(this as NewsCategoriesDto1);
  }
}
...
abstract class NewsCategoriesDto1CopyWith<$R, $In extends NewsCategoriesDto1,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, CategoryDto1,
      CategoryDto1CopyWith<$R, CategoryDto1, CategoryDto1>> get categories;
