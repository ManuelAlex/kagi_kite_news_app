...
class ClusterDto1Mapper extends ClassMapperBase<ClusterDto1> {
  ...
  static bool _$isRead(ClusterDto1 v) => v.isRead;
  static const Field<ClusterDto1, bool> _f$isRead =
      Field('isRead', _$isRead, opt: true, def: false);
  static int _$clusterNumber(ClusterDto1 v) => v.clusterNumber;
  static const Field<ClusterDto1, int> _f$clusterNumber =
      Field('clusterNumber', _$clusterNumber, key: r'cluster_number');
  static int _$uniqueDomains(ClusterDto1 v) => v.uniqueDomains;
  static const Field<ClusterDto1, int> _f$uniqueDomains =
      Field('uniqueDomains', _$uniqueDomains, key: r'unique_domains');
  static int _$numberOfTitles(ClusterDto1 v) => v.numberOfTitles;
  static const Field<ClusterDto1, int> _f$numberOfTitles =
      Field('numberOfTitles', _$numberOfTitles, key: r'number_of_titles');
  static String _$category(ClusterDto1 v) => v.category;
  static const Field<ClusterDto1, String> _f$category =
  ...
  static const Field<ClusterDto1, String> _f$shortSummary =
      Field('shortSummary', _$shortSummary, key: r'short_summary');
  static String _$didYouKnow(ClusterDto1 v) => v.didYouKnow;
  static const Field<ClusterDto1, String> _f$didYouKnow =
      Field('didYouKnow', _$didYouKnow, key: r'did_you_know');
  static List<String> _$talkingPoints(ClusterDto1 v) => v.talkingPoints;
  static const Field<ClusterDto1, List<String>> _f$talkingPoints =
      Field('talkingPoints', _$talkingPoints, key: r'talking_points');
  ...
  static const Field<ClusterDto1, String> _f$quoteAuthor =
      Field('quoteAuthor', _$quoteAuthor, key: r'quote_author');
  static String _$quoteSourceUrl(ClusterDto1 v) => v.quoteSourceUrl;
  static const Field<ClusterDto1, String> _f$quoteSourceUrl =
      Field('quoteSourceUrl', _$quoteSourceUrl, key: r'quote_source_url');
  ...
  static const Field<ClusterDto1, String> _f$quoteSourceDomain = Field(
      'quoteSourceDomain', _$quoteSourceDomain,
      key: r'quote_source_domain');
  static String _$location(ClusterDto1 v) => v.location;
  static const Field<ClusterDto1, String> _f$location =
  ...
  static const Field<ClusterDto1, String> _f$geopoliticalContext = Field(
      'geopoliticalContext', _$geopoliticalContext,
  ...
  static const Field<ClusterDto1, String> _f$historicalBackground = Field(
      'historicalBackground', _$historicalBackground,
  ...
  static const Field<ClusterDto1, String> _f$economicImplications = Field(
      'economicImplications', _$economicImplications,
      key: r'economic_implications');
  static List<TimelineDto1> _$timeline(ClusterDto1 v) => v.timeline;
  static const Field<ClusterDto1, List<TimelineDto1>> _f$timeline =
  ...
  static const Field<ClusterDto1, String> _f$businessAngleText = Field(
      'businessAngleText', _$businessAngleText,
  ...
  static const Field<ClusterDto1, String> _f$designPrinciples =
      Field('designPrinciples', _$designPrinciples, key: r'design_principles');
  ...
  static const Field<ClusterDto1, String> _f$userExperienceImpact = Field(
      'userExperienceImpact', _$userExperienceImpact,
  ...
  static const Field<ClusterDto1, List<DomainDto1>> _f$domains =
...
mixin ClusterDto1Mappable {
  String toJson() {
    return ClusterDto1Mapper.ensureInitialized()
        .encodeJson<ClusterDto1>(this as ClusterDto1);
  }

  Map<String, dynamic> toMap() {
    return ClusterDto1Mapper.ensureInitialized()
        .encodeMap<ClusterDto1>(this as ClusterDto1);
  }
  ...
  String toString() {
    return ClusterDto1Mapper.ensureInitialized()
        .stringifyValue(this as ClusterDto1);
  }

  @override
  bool operator ==(Object other) {
    return ClusterDto1Mapper.ensureInitialized()
        .equalsValue(this as ClusterDto1, other);
  }
...
abstract class ClusterDto1CopyWith<$R, $In extends ClusterDto1, $Out>
  ...
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>
      get talkingPoints;
  ListCopyWith<$R, PerspectiveDto1,
          PerspectiveDto1CopyWith<$R, PerspectiveDto1, PerspectiveDto1>>
      get perspectives;
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>
      get internationalReactions;
  ListCopyWith<$R, TimelineDto1,
      TimelineDto1CopyWith<$R, TimelineDto1, TimelineDto1>> get timeline;
  ...
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>
      get industryImpact;
  ListCopyWith<$R, ArticleDto1,
      ArticleDto1CopyWith<$R, ArticleDto1, ArticleDto1>> get articles;
...
class _ClusterDto1CopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, TimelineDto1,
          TimelineDto1CopyWith<$R, TimelineDto1, TimelineDto1>>
  ...
  @override
  ListCopyWith<$R, DomainDto1, DomainDto1CopyWith<$R, DomainDto1, DomainDto1>>
      get domains => ListCopyWith($value.domains,
          (v, t) => v.copyWith.$chain(t), (v) => call(domains: v));
  @override
  $R call(
          {bool? isRead,
          int? clusterNumber,
