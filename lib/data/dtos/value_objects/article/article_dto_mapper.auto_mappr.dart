...
import '../../../../domain/entities/value_objects/article.dart' as _i3;
import 'article_dto_1.dart' as _i2;

/// {@template package:kagi_kite_news_app/data/dtos/value_objects/article/article_dto_mapper.dart}
/// Available mappings:
/// - `ArticleDto1` → `Article`.
/// - `Article` → `ArticleDto1`.
/// {@endtemplate}
class $ArticleDtoMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:kagi_kite_news_app/data/dtos/value_objects/article/article_dto_mapper.dart}
  @override
