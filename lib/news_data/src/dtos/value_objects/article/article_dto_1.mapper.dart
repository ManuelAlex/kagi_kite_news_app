...
class ArticleDto1Mapper extends ClassMapperBase<ArticleDto1> {
  ...
  static const Field<ArticleDto1, String> _f$image =
      Field('image', _$image, opt: true);
  static String? _$imageCaption(ArticleDto1 v) => v.imageCaption;
  static const Field<ArticleDto1, String> _f$imageCaption =
      Field('imageCaption', _$imageCaption, key: r'image_caption', opt: true);
...
mixin ArticleDto1Mappable {
  String toJson() {
    return ArticleDto1Mapper.ensureInitialized()
        .encodeJson<ArticleDto1>(this as ArticleDto1);
  }

  Map<String, dynamic> toMap() {
    return ArticleDto1Mapper.ensureInitialized()
        .encodeMap<ArticleDto1>(this as ArticleDto1);
  }
  ...
  String toString() {
    return ArticleDto1Mapper.ensureInitialized()
        .stringifyValue(this as ArticleDto1);
  }

  @override
  bool operator ==(Object other) {
    return ArticleDto1Mapper.ensureInitialized()
        .equalsValue(this as ArticleDto1, other);
  }
